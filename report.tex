...
\paragraph{Safety based Route Planner}a route planner was initially proposed in conjunction with technology based around collision avoidance (which we solely later evolved) that would work and be dependent on other users (cyclists and drivers) to offer routes to the cyclist that would offer the safest journey. We defined safest journey as: 
\begin{enumerate}
\item One with limited traffic, as discovered from research [enter research], there was a positive correlation between increased traffic and increased cyclist accidents. 
\item One which avoided areas (if possible) which had a certain risk level. A high risk being an area that had a number of road related accidents (involving cyclist or vehicles), per year, above a certain threshold.
\item One which took environment factors into consideration, that were deemed a risk to cyclist. These could have been potholes in the road, blind-spots, high pedestrian activity, etc.
\end{enumerate}
 
 
\paragraph{}This was rejected as:
\begin{enumerate}
